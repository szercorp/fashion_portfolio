...
const About = () => (
  <div className="about-wrapper">
    ...
    <p className="about-text">
      ...
      textures act as a communication code for me to transfer messages that
      reflect my point of view on important issues of the society. I focused on
      the functionality of clothes with a creative outlook that would give them
      a distinctive trait. One of the most invaluable experiences that act as my
